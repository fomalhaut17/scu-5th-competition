"""
81 3-WAY BLEND v4: pred_47 4시드 평균 (BLEND_W53=0.0)
전략80(pred_47 단독, Public 2,028.04)에서 pred_47을 4시드 평균으로 개선.
pred_53는 [42,123,456,789] 4시드를 쓰는데 pred_47은 seed=42만 쓰고 있었음.
Stage1(PL2 선택)은 seed=42 한 번만, Stage2(증강 데이터 학습)를 4시드로 평균.
검증된 outer 비율 유지(50:30:20).
"""
import os
import numpy as np
import pandas as pd
